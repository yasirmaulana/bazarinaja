...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getCookie, getResponseStatus, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, setCookie, deleteCookie, readMultipartFormData, getResponseStatusText } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, join, dirname } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/@vue/shared/dist/shared.cjs.js';
...
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, encodePath } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/ofetch/dist/node.mjs';
...
import { klona } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/@nuxt/nitro-server/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/yasir/Documents/Project/flashsale/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/yasir/Documents/Project/flashsale/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/yasir/Documents/Project/flashsale/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/yasir/Documents/Project/flashsale/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yasir/Documents/Project/flashsale","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yasir/Documents/Project/flashsale/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/home/yasir/Documents/Project/flashsale/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yasir/Documents/Project/flashsale/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yasir/Documents/Project/flashsale/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/yasir/Documents/Project/flashsale/.data/kv"}));
...
const rootDir = "/home/yasir/Documents/Project/flashsale";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter+Tight:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400&display=swap"}],"style":[],"script":[],"noscript":[]};
...
const _oW10fYr3x3ephREEj9wQsyEXEEUprvosXXCTqzIQMy0 = (nitroApp) => {
...
const _yEh8pvOsNEni1YEQFGTVqVHIW9M46Ca70_JDNhaQRY = (function(nitro) {
...
const plugins = [
  _oW10fYr3x3ephREEj9wQsyEXEEUprvosXXCTqzIQMy0,
_yEh8pvOsNEni1YEQFGTVqVHIW9M46Ca70_JDNhaQRY,
...
const _EIfUO2 = eventHandler((event) => {
...
const _bDUWW5 = defineEventHandler((event) => {
...
const _i4BQfs = defineCachedEventHandler(async (event) => {
...
const _lazy_mrczri = () => Promise.resolve().then(function () { return admins_get$1; });
const _lazy_WlNNDY = () => Promise.resolve().then(function () { return admins_post$1; });
const _lazy_F3cYvO = () => Promise.resolve().then(function () { return _id__delete$5; });
const _lazy_uC1ipy = () => Promise.resolve().then(function () { return config_post$1; });
const _lazy_QboM0c = () => Promise.resolve().then(function () { return _id__delete$3; });
const _lazy_oFwclv = () => Promise.resolve().then(function () { return _id__patch$1; });
const _lazy_BAbmJr = () => Promise.resolve().then(function () { return index_get$5; });
const _lazy_ewrAU8 = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_h2Mmhs = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_vaZQmU = () => Promise.resolve().then(function () { return cancel_patch$1; });
const _lazy_ONpWNv = () => Promise.resolve().then(function () { return notify_post$1; });
...
const _lazy__uxARG = () => Promise.resolve().then(function () { return waTemplate_put$1; });
const _lazy_ToWJxT = () => Promise.resolve().then(function () { return checkout_post$1; });
const _lazy_wvYzUT = () => Promise.resolve().then(function () { return config_get$1; });
const _lazy_rsXPeC = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_bJVzt7 = () => Promise.resolve().then(function () { return status_get$1; });
const _lazy_I0CAoQ = () => Promise.resolve().then(function () { return ____path__get$1; });
const _lazy_rleta9 = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _EIfUO2, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _bDUWW5, lazy: false, middleware: true, method: undefined },
  { route: '/api/admin/admins', handler: _lazy_mrczri, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/admins', handler: _lazy_WlNNDY, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/admins/:id', handler: _lazy_F3cYvO, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admin/flash-sale/config', handler: _lazy_uC1ipy, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/flash-sale/sessions/:id', handler: _lazy_QboM0c, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admin/flash-sale/sessions/:id', handler: _lazy_oFwclv, lazy: true, middleware: false, method: "patch" },
  { route: '/api/admin/flash-sale/sessions', handler: _lazy_BAbmJr, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/login', handler: _lazy_ewrAU8, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/logout', handler: _lazy_h2Mmhs, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/orders/:id/cancel', handler: _lazy_vaZQmU, lazy: true, middleware: false, method: "patch" },
  { route: '/api/admin/orders/:id/notify', handler: _lazy_ONpWNv, lazy: true, middleware: false, method: "post" },
  ...
  { route: '/api/admin/wa-template', handler: _lazy__uxARG, lazy: true, middleware: false, method: "put" },
  { route: '/api/checkout', handler: _lazy_ToWJxT, lazy: true, middleware: false, method: "post" },
  { route: '/api/flash-sale/config', handler: _lazy_wvYzUT, lazy: true, middleware: false, method: "get" },
  { route: '/api/products', handler: _lazy_rsXPeC, lazy: true, middleware: false, method: "get" },
  { route: '/api/products/status', handler: _lazy_bJVzt7, lazy: true, middleware: false, method: "get" },
  { route: '/api/s3-image/**:path', handler: _lazy_I0CAoQ, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_rleta9, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _i4BQfs, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rleta9, lazy: true, middleware: false, method: undefined }
];

import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, defineComponent, provide, h, isVNode, createCommentVNode, Suspense, Fragment, useSSRContext, unref, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/yasir/Documents/Project/flashsale/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/yasir/Documents/Project/flashsale/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/yasir/Documents/Project/flashsale/node_modules/nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/yasir/Documents/Project/flashsale/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu, defuFn, createDefu } from "/home/yasir/Documents/Project/flashsale/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/home/yasir/Documents/Project/flashsale/node_modules/ufo/dist/index.mjs";
import { createSharedComposable } from "@vueuse/core";
import { extendTailwindMerge } from "tailwind-merge";
import { klona } from "/home/yasir/Documents/Project/flashsale/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/yasir/Documents/Project/flashsale/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DN4KNgw9.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "admin" },
    component: () => import("./_nuxt/index-s912KPbl.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: { "middleware": [] },
    component: () => import("./_nuxt/login-DyiVwfXG.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-B0YPzHYu.js")
};
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-BdWz4ERx.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DEQWKWJA.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BvoKtZQK.js"));
